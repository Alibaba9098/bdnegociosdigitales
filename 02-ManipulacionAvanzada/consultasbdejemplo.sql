...
INSERT [dbo].[Clientes] ([Num_Cli], [Empresa], [Rep_Cli], [Limite_Credito]) VALUES (2108, N'Henche & L�pez', 109, 55000.0000)
...
INSERT [dbo].[Clientes] ([Num_Cli], [Empresa], [Rep_Cli], [Limite_Credito]) VALUES (2113, N'�bero & Sagaz', 104, 20000.0000)
INSERT [dbo].[Clientes] ([Num_Cli], [Empresa], [Rep_Cli], [Limite_Credito]) VALUES (2114, N'Ori�n Ltd.', 102, 20000.0000)
...
INSERT [dbo].[Clientes] ([Num_Cli], [Empresa], [Rep_Cli], [Limite_Credito]) VALUES (2119, N'Salom�n S.A', 109, 25000.0000)
...
INSERT [dbo].[Oficinas] ([Oficina], [Ciudad], [Region], [Jef], [Objetivo], [Ventas]) VALUES (12, N'Castell�n ', N'Este', 104, 800000.0000, 735042.0000)
INSERT [dbo].[Oficinas] ([Oficina], [Ciudad], [Region], [Jef], [Objetivo], [Ventas]) VALUES (13, N'Almer�a', N'Este', 105, 350000.0000, 367911.0000)
INSERT [dbo].[Oficinas] ([Oficina], [Ciudad], [Region], [Jef], [Objetivo], [Ventas]) VALUES (21, N'Le�n', N'Oeste', 108, 745000.0000, 835915.0000)
...
INSERT [dbo].[Productos] ([Id_fab], [Id_producto], [Descripcion], [Precio], [Stock]) VALUES (N'ACI', N'4100Y', N'Zapata Peque�a', 2750.0000, 25)
INSERT [dbo].[Productos] ([Id_fab], [Id_producto], [Descripcion], [Precio], [Stock]) VALUES (N'ACI', N'4100Z', N'Zapata Mediana', 2500.0000, 28)
INSERT [dbo].[Productos] ([Id_fab], [Id_producto], [Descripcion], [Precio], [Stock]) VALUES (N'BIC', N'41003', N'H�lice', 652.0000, 3)
INSERT [dbo].[Productos] ([Id_fab], [Id_producto], [Descripcion], [Precio], [Stock]) VALUES (N'BIC', N'41089', N'Ret�n ', 225.0000, 78)
...
INSERT [dbo].[Productos] ([Id_fab], [Id_producto], [Descripcion], [Precio], [Stock]) VALUES (N'IMM', N'887P ', N'Bul�n ', 250.0000, 24)
INSERT [dbo].[Productos] ([Id_fab], [Id_producto], [Descripcion], [Precio], [Stock]) VALUES (N'IMM', N'887X ', N'Brazo ret�n ', 475.0000, 32)
...
INSERT [dbo].[Productos] ([Id_fab], [Id_producto], [Descripcion], [Precio], [Stock]) VALUES (N'QSA', N'XK48A', N'Reducci�n', 177.0000, 37)
...
INSERT [dbo].[Representantes] ([Num_Empl], [Nombre], [Edad], [Oficina_Rep], [Puesto], [Fecha_Contrato], [Jefe], [Cuota], [Ventas]) VALUES (104, N'Bernardo S�nchez', 33, 12, N'Jefe Ventas', CAST(N'1987-05-19' AS Date), 106, 200000.0000, 142594.0000)
...
INSERT [dbo].[Representantes] ([Num_Empl], [Nombre], [Edad], [Oficina_Rep], [Puesto], [Fecha_Contrato], [Jefe], [Cuota], [Ventas]) VALUES (107, N'Neus Azc�rate', 49, 22, N'Representante', CAST(N'1988-11-14' AS Date), 108, 300000.0000, 186042.0000)
INSERT [dbo].[Representantes] ([Num_Empl], [Nombre], [Edad], [Oficina_Rep], [Puesto], [Fecha_Contrato], [Jefe], [Cuota], [Ventas]) VALUES (108, N'Le�n Freire', 62, 21, N'Jefe Ventas', CAST(N'1989-10-12' AS Date), 106, 350000.0000, 361865.0000)
INSERT [dbo].[Representantes] ([Num_Empl], [Nombre], [Edad], [Oficina_Rep], [Puesto], [Fecha_Contrato], [Jefe], [Cuota], [Ventas]) VALUES (109, N'Mar�a Jim�nez', 31, 11, N'Representante', CAST(N'1989-10-12' AS Date), 106, 320000.0000, 392725.0000)
INSERT [dbo].[Representantes] ([Num_Empl], [Nombre], [Edad], [Oficina_Rep], [Puesto], [Fecha_Contrato], [Jefe], [Cuota], [Ventas]) VALUES (110, N'Tom�s Saz', 41, NULL, N'Representante', CAST(N'1990-01-13' AS Date), 101, NULL, 75985.0000)
GO
...
-- Crear una lista que visualiza el total de los importes agrupados por productos
...
AS
SELECT r.Nombre, 
	r.Ventas AS [Ventas Representante],
	o.Oficina, 
	o.Ciudad, 
	o.Region, 
	o.Ventas AS [Ventas Oficina]
...
-- Seleccionar los pedidos con fecha en importe, el nombre del representante que lo atendio al cliente y al cliente que lo solicito
...
-- ¿Qué representantes tienen ventas que superan su cuota?
SELECT Nombre, Ventas, Cuota
FROM Representantes
WHERE Ventas > Cuota

/*
Obtén la Descripcion, el Precio y el Stock de la tabla Productos. 
Solo debes incluir aquellos productos que cuesten estrictamente más de $100 
y cuyo stock sea menor o igual a 20. Ordena el resultado por el precio, 
...
/*
Muestra el Nombre, el Puesto y la Edad de todos los Representantes que firmaron su contrato (Fecha_Contrato) durante el año 1988.
*/

SELECT Nombre, Puesto, Edad, Fecha_Contrato
FROM Representantes
WHERE YEAR(Fecha_Contrato) = 1988;

/*
Ve a la tabla Pedidos y calcula dos cosas: el importe total acumulado de todas las ventas (suma) y el importe promedio de esas ventas. 
Pero ojo, solo debes calcular esto para los pedidos que se hicieron específicamente en el mes de enero de 1990.
*/

SELECT  SUM(Importe) AS [Importe total] , AVG(Importe) AS [Importe Promedio]
FROM Pedidos
WHERE DATEPART(MONTH, Fecha_Pedido) = 1
AND DATEPART(YEAR, Fecha_Pedido) = 1990

/*
Genera un reporte que muestre el nombre de la Empresa cliente, 
su Limite_Credito y el Nombre del representante que la atiende. 
Ordena la lista alfabéticamente por el nombre de la empresa.
*/

SELECT c.Empresa, c.Limite_Credito, r.Nombre AS [Nombre del representante que la atiende]
FROM Clientes AS c
INNER JOIN Representantes AS r
...
/*
Muestra el Num_Pedido, la Fecha_Pedido, la Descripcion del producto vendido
y la Cantidad. Debes filtrar el resultado para que solo aparezcan los pedidos 
donde la cantidad vendida sea mayor a 10. (Pista: No olvides cómo conectar 
correctamente la tabla de Pedidos con la de Productos).
*/

SELECT p.Num_Pedido, p.Fecha_Pedido, pr.Descripcion, p.Cantidad
FROM Pedidos AS p
INNER JOIN Productos AS pr
...
/*
Queremos saber cuánto ha vendido cada sede. Muestra la Ciudad de la oficina 
y la suma total de los importes (Importe) de los pedidos que han cerrado los 
representantes que trabajan en esa respectiva oficina.
*/

SELECT o.Ciudad, SUM(p.Importe) AS [Suma Total]
FROM Oficinas AS o
INNER JOIN Representantes AS r
...
/*
Escribe el código para crear una vista llamada Vista_Stock_Bajo. Esta vista debe 
mostrar el Id_fab, el Id_producto, la Descripcion y el Stock de la tabla de productos, 
pero solo de aquellos artículos que tengan 15 unidades o menos en su inventario.
*/
CREATE OR ALTER VIEW Vista_Stock_Bajo
AS
SELECT Id_Fab, Id_producto, Descripcion, Stock
FROM Productos
WHERE Stock <= 15
...
/*
Crea una vista llamada Vista_Rendimiento_Vendedores que integre información de los 
empleados. Debe mostrar el Nombre del representante, su Puesto, la Ciudad de la 
oficina donde trabaja (requiere un INNER JOIN con Oficinas), su Cuota asignada y 
sus Ventas reales.
*/
CREATE OR ALTER VIEW Vista_Rendimiento_Vendedores
AS
SELECT r.Nombre, r.Puesto, o.Ciudad, r.Cuota, r.Ventas
FROM Representantes AS r
INNER JOIN Oficinas AS o
ON r.Oficina_Rep = o.Oficina

SELECT * FROM Vista_Rendimiento_Vendedores

/*
Genera un reporte que muestre el Num_Pedido, la Descripcion del producto vendido, 
la Cantidad comprada y el Precio unitario original del producto. Solo incluye aquellos 
pedidos donde la cantidad comprada multiplicada por el precio unitario del producto 
sea mayor a $5,000.
*/

SELECT p.Num_Pedido, pr.Descripcion, p.Cantidad, pr.Precio, 
	(p.Cantidad * pr.Precio) AS [Valor total en cantidad]
FROM Pedidos AS p
INNER JOIN Productos AS pr
ON p.Fab = pr.Id_fab AND p.Producto = pr.Id_producto
WHERE (p.Cantidad * pr.Precio) > 5000

/*
Muestra el nombre de la Empresa (cliente), su Limite_Credito y la suma total del 
dinero que han gastado (SUM(Importe)) en todos sus pedidos. Solo debes mostrar a 
los clientes cuya suma total de compras sea estrictamente mayor a su límite de crédito 
actual.
*/

SELECT c.Empresa, c.Limite_Credito, 
	SUM(p.Importe) AS [Suma total del dinero que han gastado]
FROM Clientes AS c
INNER JOIN Pedidos AS p
ON c.Num_Cli = p.Cliente
GROUP BY c.Empresa, c.Limite_Credito
HAVING SUM(p.Importe) > c.Limite_Credito

/*
Escribe una consulta que muestre el Nombre del representante, sus Ventas reales, 
el Nombre de su jefe y las Ventas de su jefe. Solo deben aparecer en la lista los 
representantes que tengan un total de ventas mayor al total de ventas de su propio jefe.
*/

SELECT r.Nombre, r.Ventas, r.Jefe, rj.Ventas AS [Ventas del Jefe]
FROM Representantes AS r
INNER JOIN Representantes AS rj
ON r.Jefe = rj.Num_Empl
WHERE r.Ventas > rj.Ventas
GO

/*
Muestra la Region de la oficina, la Descripcion del producto y la suma total de la 
Cantidad vendida. Filtra los datos para que solo se cuenten los pedidos realizados 
durante el año 1990. El resultado final debe estar agrupado por la región y por la 

...
El `alumno` creara base de datos relacionales y no relacionales a través de esquemas de **administracion** y  *seguridad* para manipular datos almacenados en la nube.
...
![imagen Base de datos.](/img/imagen02.png "This is a sample image.")
...
![imagen Principal.](/img/Imagen02.png "This is a sample image.")
